...
> 质量保障：质检过程与证据见 [docs/QUALITY-REPORT.md](docs/QUALITY-REPORT.md)，独立评审报告见 [docs/QUALITY-REVIEW-REPORT.md](docs/QUALITY-REVIEW-REPORT.md)，规则溯源见 [docs/RULES.md](docs/RULES.md)。发布流程见 [docs/RELEASE.md](docs/RELEASE.md)，CI 接入见 [docs/CI-INTEGRATION.md](docs/CI-INTEGRATION.md)。
